    ...
    <article className='grid grid-cols-1 md:grid-cols-12 gap-y-5'>
      <div className='col-span-7 place-self-center text-center sm:text-left'>
        ...
        <p className='text-[#ADB7BE] text-left text-base sm:text-lg mb-6 lg:text-lg break-words md:pr-10'>
          Soy desarrollador Full Stack y me dedico a crear aplicaciones web y
          móviles. Durante mi carrera he trabajado tanto en el Frontend como en
          el Backend por lo que ambos son áreas que manejo cómodamente.&nbsp;
