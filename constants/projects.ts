const projects = [
    {
        ...
        title: 'FranStore',
        description: 'Ecommerce creada para la venta de distintas clases de productos como ropa, juguetes, etc.',
        gitHubUrl: 'https://github.com/FranciscoJSB12/fran-store',
        projectUrl: 'https://franstore.netlify.app/#/home',
        stack: ['Tailwind', 'React', 'Redux', 'Typescript', ' Vite'],
        role: 'Desarrollador Frontend'
    },
    {
        imageSrc: '/images/pokeworld.png',
        title: 'PokeWorld',
        description: 'Sitio web creado para los fanáticos de Pokemon donde podrás encontrar más de 1000 personajes y sus datos curiosos.',
        gitHubUrl: 'https://github.com/FranciscoJSB12/prueba-tecnica-jr-frontend',
        projectUrl: 'https://prueba-tecnica-jr-frontend.vercel.app/',
        stack: ['Tailwind', 'React', 'Nextjs', 'Typescript'],
        role: 'Desarrollador Frontend'
    },
    {
